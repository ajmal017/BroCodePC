...
def before_trading_start(context, data):
    ...
    log.info("Worst stocks: {}".format(context.stocks_worst[:40]))
    log.info("Worst stocks: {}".format(context.stocks_worst[40:80]))
    log.info("Worst stocks: {}".format(context.stocks_worst[80:]))
